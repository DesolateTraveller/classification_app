...
#---------------------------------------------------------------------------------------------------------------------------------
            ...
            #with tab9:                   
                ...
                #train = h2o.H2OFrame(pd.concat([X_train, train_labels], axis=1))
                #test = h2o.H2OFrame(pd.concat([X_test, test_labels], axis=1))
                ...
                #st.subheader("Leaderboard", divider='blue')
                #st.write(aml.leaderboard)
